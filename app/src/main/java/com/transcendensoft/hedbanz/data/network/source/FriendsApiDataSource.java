...
public class FriendsApiDataSource extends ApiDataSource implements FriendDataSource {
    ...
    @Override
    public Observable<FriendDTO> getFriendsForUser(long friendId, long forUserId) {
        return mService.getFriendForUser(friendId, forUserId);
    }
    ...
    @Override
    public Completable declineFriend(long userId, long friendId) {
        return mService.declineFriend(userId, friendId);
    }
}
