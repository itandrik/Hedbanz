...
public class RoomFilterDTO {
    ...
    private RoomFilterDTO(String roomName, Byte maxPlayers, Byte minPlayers, Boolean isPrivate) {
    ...
    public static class Builder {
        ...
        public RoomFilterDTO build() {
            return new RoomFilterDTO(roomName, maxPlayers, minPlayers, isPrivate);
        }
    }
}
