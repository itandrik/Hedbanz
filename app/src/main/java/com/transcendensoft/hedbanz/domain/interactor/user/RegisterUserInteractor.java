 ...
 * that represents a use case for user registration. Data related to a specific
...
public class RegisterUserInteractor extends ObservableUseCase<User, User> {
    private UserCredentialsException mUserException;
    private UserDataRepository mUserRepository;

    @Inject
    public RegisterUserInteractor(ObservableTransformer mSchedulersTransformer,
    ...
    private Observable<User> processRegisterUserOnError(Throwable throwable) {
