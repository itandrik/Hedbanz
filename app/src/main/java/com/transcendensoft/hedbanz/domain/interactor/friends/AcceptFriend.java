 ...
 * that represents a use case for accepting friends requests
 *
 * @author Andrii Chernysh. E-mail: itcherry97@gmail.com
 *         Developed by <u>Transcendensoft</u>
 */
public class AcceptFriend extends CompletableUseCase<AcceptFriend.Param> {
    private FriendsDataRepository mRepository;
    private PreferenceManager mPreferenceManger;

    @Inject
    public AcceptFriend(CompletableTransformer schedulersTransformer,
    ...
    @Override
    protected Completable buildUseCaseCompletable(AcceptFriend.Param params) {
        return mRepository.acceptFriend(mPreferenceManger.getUser().getId(),
