 ...
 * that represents a use case listening socket reconnecting.
 *
 * @author Andrii Chernysh. E-mail: itcherry97@gmail.com
 *         Developed by <u>Transcendensoft</u>
 */
public class OnReconnectingUseCase extends ObservableUseCase<String, Void> {
    private PublishSubject<String> mSubject;

    @Inject
    public OnReconnectingUseCase(ObservableTransformer observableTransformer,
                              CompositeDisposable mCompositeDisposable,
                              GameDataRepository gameDataRepository) {
        super(observableTransformer, mCompositeDisposable);

        Observable<String> observable = gameDataRepository.reconnectingObservable()
