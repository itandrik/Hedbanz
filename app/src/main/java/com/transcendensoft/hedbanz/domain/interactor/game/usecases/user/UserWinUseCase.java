 ...
 * information when some user wins game.
 *
 * @author Andrii Chernysh. E-mail: itcherry97@gmail.com
 *         Developed by <u>Transcendensoft</u>
 */
public class UserWinUseCase extends ObservableUseCase<User, Void> {
    private PublishSubject<User> mSubject;

    @Inject
    public UserWinUseCase(ObservableTransformer observableTransformer,
    ...
    private void initSubject(GameDataRepository gameDataRepository) {
        Observable<User> observable = gameDataRepository.userWin();
