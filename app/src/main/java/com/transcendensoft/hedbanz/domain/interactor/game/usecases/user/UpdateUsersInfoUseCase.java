 ...
 * users words changed with each other, so there is needed to update menu
 *
 * @author Andrii Chernysh. E-mail: itcherry97@gmail.com
 *         Developed by <u>Transcendensoft</u>
 */
public class UpdateUsersInfoUseCase  extends ObservableUseCase<Room, Void> {
    private PublishSubject<Room> mSubject;

    @Inject
    public UpdateUsersInfoUseCase(ObservableTransformer observableTransformer,
    ...
    private void initSubject(GameDataRepository gameDataRepository) {
        Observable<Room> observable = gameDataRepository.updateUsersInfoObservable();
