...
public class MessageUseCase extends ObservableUseCase<Message, Void> {
    ...
    private void initSubject(GameDataRepositoryImpl gameDataRepository, Gson gson) {
        Observable<Message> observable = getObservable(gameDataRepository, gson);
        mSubject = PublishSubject.create();
        observable.subscribe(mSubject);
    }

    private Observable<Message> getObservable(GameDataRepositoryImpl gameDataRepository, Gson gson) {
