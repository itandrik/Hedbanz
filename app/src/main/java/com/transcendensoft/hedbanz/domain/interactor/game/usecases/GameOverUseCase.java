 ...
 * that represents a use case listening nothing
 * information when game is over
 *
 * @author Andrii Chernysh. E-mail: itcherry97@gmail.com
 *         Developed by <u>Transcendensoft</u>
 */
public class GameOverUseCase extends ObservableUseCase<Boolean, Void> {
    private PublishSubject<Boolean> mSubject;

    @Inject
    public GameOverUseCase(ObservableTransformer observableTransformer,
    ...
    private void initSubject(GameDataRepository gameDataRepository) {
        Observable<Boolean> observable = gameDataRepository.gameOverObservable();
