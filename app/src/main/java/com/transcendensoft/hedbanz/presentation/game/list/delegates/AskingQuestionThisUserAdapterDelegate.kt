 ...
 */
/**
 * This delegate is responsible for creating {@link AskingQuestionThisUserViewHolder}
 ...
 */
class AskingQuestionThisUserAdapterDelegate @Inject constructor() : AdapterDelegate<List<@JvmSuppressWildcards Message>>() {
    override fun onCreateViewHolder(parent: ViewGroup?): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        val context = parent?.context
        val itemView = LayoutInflater.from(context)
                .inflate(R.layout.item_asking_question_this_user, parent, false)
        return AskingQuestionThisUserViewHolder(context!!, itemView)
    }
