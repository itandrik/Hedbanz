...
import com.transcendensoft.hedbanz.presentation.changeicon.ChangeIconPresenter
import dagger.Binds
 ...
 * and other instances for feedback presentations
 *
...
interface FeedbackModule {
    @ActivityScope
    @Binds
    fun bindPresenter(feedbackPresenter: FeedbackPresenter): FeedbackContract.Presenter
}