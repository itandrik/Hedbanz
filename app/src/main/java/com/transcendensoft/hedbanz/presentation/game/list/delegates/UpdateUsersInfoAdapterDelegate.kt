...
import com.transcendensoft.hedbanz.presentation.game.list.holder.UpdateUsersInfoViewHolder
 ...
 */
/**
 * This delegate is responsible for creating {@link UpdateUsersInfoViewHolder}
 ...
 */
class UpdateUsersInfoAdapterDelegate @Inject constructor() :
        AdapterDelegate<List<@JvmSuppressWildcards Message>>() {
    override fun onCreateViewHolder(parent: ViewGroup?): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        val context = parent?.context
        val itemView = LayoutInflater.from(context)
                .inflate(R.layout.item_update_users_info, parent, false)
        return UpdateUsersInfoViewHolder(itemView)
    }

    override fun isForViewType(items: List<Message>, position: Int): Boolean {
        val message = items[position]
        return message.messageType == MessageType.UPDATE_USERS_INFO
    }
