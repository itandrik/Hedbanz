 ...
 * and other instances for restore password presentations
 *
 * @author Andrii Chernysh. E-mail: itcherry97@gmail.com
 * Developed by <u>Transcendensoft</u>
 */
@Module
public interface RestorePasswordModule {
    @ActivityScope
    @Binds
    ...
    @FragmentScope
    @ContributesAndroidInjector
    CheckKeywordFragment checkKeywordFragment();
    ...
    @Binds
    @ActivityContext
    Context provideRestorePasswordActivityContext(RestorePasswordActivity restorePasswordActivity);
