...
import com.transcendensoft.hedbanz.presentation.game.list.holder.WaitingForUsersViewHolder
 ...
 */
/**
 * This delegate is responsible for creating {@link WaitingForUsersViewHolder}
...
class WaitingForGameAdapterDelegate @Inject constructor() : AdapterDelegate<List<@JvmSuppressWildcards Message>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(context)
                .inflate(R.layout.item_waiting_for_users, parent, false)
        return WaitingForUsersViewHolder(itemView)
    }

    override fun isForViewType(items: List<Message>, position: Int): Boolean {
        val message = items[position]
        return message.messageType == MessageType.WAITING_FOR_USERS
    }
